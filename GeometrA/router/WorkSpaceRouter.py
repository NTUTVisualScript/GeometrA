...
@app.route('/GeometrA/WorkSpace')
def getWorkSpace():
    return jsonify(ws.getTreeJSON())

@app.route('/GeometrA/WorkSpace/create', methods=['POST'])
def createProject():
...
@app.route('/GeometrA/WorkSpace/load', methods=['POST'])
def loadProjects():
...
@app.route('/GeometrA/WorkSpace/getFilePath')
def getFilePath():
    root = Tk()
...
@app.route('/GeometrA/WorkSpace/getProjectPath')
def getProjectPath():
    root = Tk()
...
@app.route('/GeometrA/WorkSpace/addSuite', methods=['POST'])
def addSuite():
...
@app.route('/GeometrA/WorkSpace/addCase', methods=['POST'])
def addCase():
    project = request.form['Project']
...
@app.route('/GeometrA/WorkSpace/delete', methods=['POST'])
def deleteFile():
...
@app.route('/GeometrA/WorkSpace/rename', methods=['POST'])
def rename():
...
@app.route('/GeometrA/WorkSpace/save', methods=['POST'])
def save():
...
@app.route('/GeometrA/WorkSpace/open', methods=['POST'])
def open():
    focus = request.form
    ws.setFocus(focus)
    xml = ws.open()
